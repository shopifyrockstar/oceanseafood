;(function() {
	...
	function init() {
		...
		window.gtag("config", "AW-936806899");
		...
		if(Conversion) {
			...
			window.gtag("event", "conversion", {
				'send_to' : "AW-936806899/CL6lCJ3g3oEDEPOT2r4D",
		...
		if(!("run" in load)) {
			...
			if(!("dataLayer" in window)) {
				...
				if(!hasScript) {
					...
					script.setAttribute("src", "https://www.googletagmanager.com/gtag/js?id=AW-936806899");
